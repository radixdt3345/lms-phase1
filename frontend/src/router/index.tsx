    ...
    <BrowserRouter>
      <Suspense fallback={<Box sx={{ display: 'flex', justifyContent: 'center', mt: 4 }}><CircularProgress /></Box>}>
        <Routes>
          ...
          <Route path="/leave-types" element={<ProtectedRoute><LeaveTypeListPage /></ProtectedRoute>} />
          ...
          <Route path="/public-holidays" element={<ProtectedRoute><PublicHolidayListPage /></ProtectedRoute>} />
