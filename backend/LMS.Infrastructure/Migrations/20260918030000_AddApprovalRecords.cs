        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    // FK to leave_requests — restrict delete to prevent orphan approval records
                    table.ForeignKey(
                        name: "fk_approval_records_leave_request_id",
                        column: x => x.leave_request_id,
                        principalTable: "leave_requests",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);

                    // FK to comp_off_requests — nullable; restrict delete when set
                    table.ForeignKey(
                        name: "fk_approval_records_comp_off_request_id",
                        column: x => x.comp_off_request_id,
                        principalTable: "comp_off_requests",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);

                    // FK to users (approver) — restrict delete
                    table.ForeignKey(
            ...
            // Partial index for pending approvals — used by Hangfire daily reminder job
