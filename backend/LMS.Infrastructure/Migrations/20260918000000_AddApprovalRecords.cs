        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    // FK to users (approver) — always enforced
                    table.ForeignKey(
            ...
            // Composite index for querying all approvals on a specific leave request at a given level
            migrationBuilder.CreateIndex(
                name: "idx_approval_records_leave_request_level",
                table: "approval_records",
                columns: new[] { "leave_request_id", "level" });

            // Index for approver workload queries (pending and past actions)
            migrationBuilder.CreateIndex(
            ...
            // Partial index for pending approvals (acted_at IS NULL, soft-delete aware)
